...
<!--   <link rel="stylesheet" href="/resources/demos/style.css"> -->
		<link href="../assets/global/plugins/bootstrap-treeview/css/bootstrap-treeview.css" />
        ...
        <link href="../assets/global/plugins/bootstrap-timepicker/css/bootstrap-timepicker.css" rel="stylesheet" type="text/css" />
         <link href="../assets/global/plugins/bootstrap-clockpicker/css/bootstrap-clockpicker.min.css" rel="stylesheet" type="text/css" />
		...
		<link href="../assets/global/dist/handsontable.full.min.css" rel="stylesheet" type="text/css" >
        ...
        <div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    <!-- BEGIN LOGO -->
                    <label style="display: none;" id="user" ><%session.getAttribute("USER");%></label> 
                    <div class="page-logo">
                        <a href="infoPage">
                            <img src="../assets/layouts/layout/img/recotec01.png" alt="logo" class="logo-default" style="width: 80px; height: 40px"/> </a>
...
<!--                         </h1> -->
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> 2019 &copy; Goplicity
...
<![endif]-->
        ...
        <!--  <script src="../assets/global/plugins/datatables/jquery.dataTables.min.js" type="text/javascript"></script>-->
       ...
       <!--   <script src="https://cdn.datatables.net/1.10.21/js/jquery.dataTables.min.js" type="text/javascript"></script>
        ...
        <script src="https://cdn.datatables.net/1.10.21/css/jquery.dataTables.min.css" type="text/css"></script>
        <script src="https://cdn.datatables.net/responsive/2.2.5/css/responsive.dataTables.min.css" type="text/css"></script>
        <script src="https://cdn.datatables.net/responsive/2.2.5/css/responsive.dataTables.min.css" type="text/css"></script>-->
		...
		<script src="../assets/global/plugins/bootstrap-treeview/js/bootstrap-treeview.js" type="text/javascript"></script>
        ...
        <c:if test="${not empty selectPicker}">
			<script ${selectPicker}></script>
		</c:if>
        <c:if test="${not empty stackpath}">
			<script ${stackpath}></script>
		</c:if> 
...
<!-- 		Sweet Alert 2 -->
		...
		<script src="../assets/global/dist/handsontable.full.min.js"></script>
		<script src="../assets/global/plugins/bootstrap-clockpicker/js/bootstrap-clockpicker.min.js"></script>
