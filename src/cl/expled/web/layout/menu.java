			...
			while (f.hasNext()) {
				...
				else
				{
					...
					if (row.getAdm().equals("Y"))
						menu += "			<li class='nav-item  " + menuActive + "'><a href='/fx/webApp/pageAdm/"+row.getUrl()+"'";
					else if (row.getAdm().equals("O"))
						menu += "			<li class='nav-item  " + menuActive + "'><a href='/fx/webApp/"+row.getUrl()+"'";
					else
						menu += "			<li class='nav-item  " + menuActive + "'><a href='/fx/webApp/page/"+row.getUrl()+"'";
