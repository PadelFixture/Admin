...
public class RENDIMIENTO_DIARIO {
	...
	public String nMacro;
	public String nOrdenco;
	public String nCeco;
	...
	public String getnCeco() {
		return nCeco;
	}
	public void setnCeco(String nCeco) {
		this.nCeco = nCeco;
	}
	public String getnOrdenco() {
		return nOrdenco;
	}
	public void setnOrdenco(String nOrdenco) {
		this.nOrdenco = nOrdenco;
	}
	public String getnMacro() {
		return nMacro;
	}
	public void setnMacro(String nMacro) {
		this.nMacro = nMacro;
	}
