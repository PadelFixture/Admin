...
//	}
	...
	$.ajax({
		...
		datos = [];
		$.each(response.data, function(k,v){
			var tbl = [ v.DISTRIBUIDOR, v.SUBDISTRIBUIDOR, v.VENDEDOR, v.COMERCIO, v.factura, v.iccid, v.material, v.imei, v.imsi, v.fecha_doc ];
			datos.push(tbl);
		})
		if(tabla){
			tabla.destroy();
		...
		columnas = ["Distribuidor", "Sub Distribuidor","Vendedor","Comercio","Factura", "Iccid","Material","Imei","Imsi","Fecha Documento"];
		var finalColumn = [];
