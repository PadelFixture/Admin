...
<div class="col-xs-12 col-sm-12 col-md-12 divVendedor"  style="display:none">
	<div class="col-xs-12 col-sm-3 col-md-3" >
		<label style="color: #337ab7;font-weight: bold;" >Tipo Devolución: </label>
	</div>
	<div class="col-xs-12 col-sm-3 col-md-3" >
		<input type='checkbox' title='Vendedor/Comercio' style="width:164px" checked data-toggle="toggle" id="check_ingreso" data-size="max" data-onstyle="info" onchange='withCuartel(this);' class='checkbox'/>
	</div>
</div>
<div class="col-xs-12 col-sm-12 col-md-12 divVendedor"  style="display:none">
	<div class="col-xs-12 col-sm-3 col-md-3" >
...
<div style="text-align: center;" class="">
	<button onclick="vender()" id="vender" class="btn green-dark submit" style="display:none">
		<i class="icon-cloud-upload"></i> Devolver
	</button>
</div> 
