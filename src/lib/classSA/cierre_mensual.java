...
public class cierre_mensual {
	...
	public String nombreCen;
	public String nombreIm;
	public String nombreCeco;
	public String nombreOrdenCo;
	...
	public String getNombreOrdenCo() {
		return nombreOrdenCo;
	}
	public void setNombreOrdenCo(String nombreOrdenCo) {
		this.nombreOrdenCo = nombreOrdenCo;
	}
