...
public class TrabajadoresPostulantes {
	...
	private String movilizacionFija;
	...
	private String idFaenaContrato;
	private String tipoMoneda;
	private String criterio_postulancion;
	private String sueldoBase;
	
	
	
	
	public int getEstadoproce() {
		return estadoproce;
	}
	public void setEstadoproce(int estadoproce) {
	...
	public String getMovilizacionFija() {
		return movilizacionFija;
	}
	public void setMovilizacionFija(String movilizacionFija) {
	...
	public String getIdFaenaContrato() {
		return idFaenaContrato;
	}
	public void setIdFaenaContrato(String idFaenaContrato) {
	...
	public String getCriterio_postulancion() {
		return criterio_postulancion;
	}
	public void setCriterio_postulancion(String criterio_postulancion) {
		this.criterio_postulancion = criterio_postulancion;
	}
