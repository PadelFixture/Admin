...
<html lang="en" >
    ...
    <body class=" login">
        ...
        <div class="logo">
                ...
                <img src="../assets/layouts/layout/img/recotec.png" style="width: 300px;" alt="" /> 
        </div>
        ...
        <div class="content" >
            ...
            <form class="login-form" id="form1"  method="post">
                <h3 class="form-title" style="color:#666 !important;">Ingresar</h3>
      ...
      <!-- <div class="logo">           
                <img src="../assets/layouts/layout/img/entel.png" style="width: 300px;" alt="" /> 
        </div> -->  
        <div class="copyright"> 2019 &copy; power by Goplicity </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
