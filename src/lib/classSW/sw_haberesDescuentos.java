...
public class sw_haberesDescuentos {
	...
	public String nombreCuotas;
	public String fechaistring;
	public String fechatstring;
	
	
	public String getFechaistring() {
		return fechaistring;
	}
	public void setFechaistring(String fechaistring) {
		this.fechaistring = fechaistring;
	}
	public String getFechatstring() {
		return fechatstring;
	}
	public void setFechatstring(String fechatstring) {
		this.fechatstring = fechatstring;
	}
	public String getNombreCuotas() {
		return nombreCuotas;
	}
	public void setNombreCuotas(String nombreCuotas) {
		this.nombreCuotas = nombreCuotas;
	}
	...
	public int getEstadoCambio() {
		return estadoCambio;
	}
	public void setEstadoCambio(int estadoCambio) {
